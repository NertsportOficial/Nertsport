...
<form class="form-horizontal" role="form" method="post" action="index.php?action=register">
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" name="NOMBRE" class="form-control" id="inputEmail1" placeholder="Nombre">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Apellido</label>
    <div class="col-lg-10">
      <input type="text" name="APELLIDO" class="form-control" id="inputEmail1" placeholder="Apellido">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="password" name="CONFIRMAR_CONTRASEÑA" class="form-control" id="inputPassword1" placeholder="Confirmar Contrase&ntilde;a">
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        <label>
          <input type="checkbox" name="ACEPTAR" required> Acepto terminos y condiciones de uso
        </label>
      </div>
    </div>
  </div>
