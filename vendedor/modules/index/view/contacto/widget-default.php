...
<form role="form" method="post" action="./?action=contact">
  <div class="form-group">
    ...
    <input type="text" name="NOMBRE" class="form-control" id="exampleInputEmail1" placeholder="Tu nombre">
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Correo Electronico</label>
    <input type="email" name="CORREO" class="form-control" id="exampleInputEmail1" placeholder="Tu email" required>
  </div>
  <div class="form-group">
