...
<a href="javascript:void()" class="btn btn-labeled btn-sm btn-warning tip" title="No disponible">
                <span class="btn-label"><i class="glyphicon glyphicon-eye-close"></i></span> No Disponible</a>
<br>
...
<center><a href="javascript:void()" class="btn btn-labeled btn-sm btn-success tip" title="Ya esta en el carrito">
                <span class="btn-label"><i class="glyphicon glyphicon-ok"></i></span> Ya esta agregado</a>
<br>
<?php endif; ?>
<a href="index.php?view=producto&PRODUCTO_ID=<?php echo $p->ID_PRODUCTO; ?>">Detalles</a>
                </center>
