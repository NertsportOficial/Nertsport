...
if(isset($_SESSION["VENDEDOR_ID"]) && $_SESSION["VENDEDOR_ID"]!=""):
  $u = UserData::getById($_SESSION["VENDEDOR_ID"]);
?>
<body>
<div class="col-sm-12">
    ...
    <br><br>
     ...
     <p class="w3-center"><img src="usua.png" class="w3-circle" width="100" height="100"><center><h3>VENDEDOR</h3></center></p>
      <ul class="nav nav-pills nav-stacked">
        <li class="active">
        <li><button type="button" class="w3-button w3-orange"><a href="javascript:void(0)"onclick="document.getElementById('newslett').style.display='block'">Realizar venta</a></button>
        </li>
        <br><br>
