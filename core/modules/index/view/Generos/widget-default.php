...
$Genero = UnitData::getByPreffix($_GET["Genero"]);
$products = ProductData::getPublicsByGeneroId($Genero->ID_GENERO);
...
<section>
  ...
  <div class="col-md-12">
    ...
    if(isset($_GET["act"]) && $_GET["act"]!=""){ echo "Busqueda: ".$_GET["Q"]; }else { echo $Genero->NOMBRE; } ?></div>
<br>
<?php
...
if(isset($_SESSION["Genero"])){
  foreach ($_SESSION["Genero"] as $pc) {
    if($pc["PRODUCTO_ID"]==$p->ID_GENERO){ $in_cart=true;  }
  }
  }
