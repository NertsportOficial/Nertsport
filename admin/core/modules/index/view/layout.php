...
<html>  
   <head>
    <meta charset="UTF-8">
    <title>Nert Sport | Administracion</title>
...
<script type="text/javascript" src="plugins/jsqrcode/webqr.js"></script>
  ...
  <body class="skin-black sidebar-mini">
    <div class="wrapper">
      <!-- Main Header -->
      <?php if(isset($_SESSION["admin_id"]) || isset($_SESSION["client_id"])):?>
      <header class="main-header" >
        <!-- Logo -->
        <a href="./" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini" style="color: aliceblue"><b>N</b>S</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg" style="color: aliceblue"><b>Nert</b>Sport</span>
        </a>

        <!-- Header Navbar -->
        <nav class="navbar navbar-static-top" role="navigation">
          <!-- Sidebar toggle button-->
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button" style="color: aliceblue">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="" style="color: aliceblue"><?php 
					  if(isset($_SESSION["admin_id"]) ){ echo UserData::getById($_SESSION["admin_id"])->NOMBRES; 
					echo " ". UserData::getById($_SESSION["admin_id"])->APELLIDOS; }?> 
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-right">
                     <a href="index.php?view=configuration" class="btn btn-default btn-flat">Configuracion</a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="./?view=products"><i class='fa fa-cube'></i> <span>Productos</span></a></li>
            <?php endif;?>
    ...
    <?php endif;?>
      ...
      <div class="content">
        ...
        <strong>Copyright &copy; 2018 <a href="../" target="_blank">NertSport</a></strong>
      </footer>
      <?php else:?>
<div class="login-box">
      <div class="login-logo">
        <a href="./" style="color: aliceblue">NERT<b>SPORT</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <form action="login.php" method="post">
          <div class="form-group has-feedback">
            <input type="text" name="CORREO" required class="form-control" placeholder="Usuario"/>
