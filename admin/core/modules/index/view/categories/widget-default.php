...
<form class="form-horizontal" role="form" method="post" action="index.php?action=addcategory">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" required class="form-control" name="NOMBRE_CORTO" placeholder="Nombre corto">
    </div>
  </div>
  <div class="form-group">
...
<?php foreach($categories as $cat):?>
                        ...
                        <td style="width:90px;">
                        <a data-toggle="modal" href="#myModal-<?php echo $cat->ID_CATEGORIA;?>" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a> 
  <!-- Button trigger modal -->

  <!-- Modal -->
  <div class="modal fade" id="myModal-<?php echo $cat->ID_CATEGORIA;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<form class="form-horizontal" role="form" method="post" action="index.php?action=updatecategory">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Nombre Corto</label>
    <div class="col-lg-10">
      <input type="text" required class="form-control" value="<?php echo $cat->NOMBRE_CORTO; ?>" name="NOMBRE_CORTO" placeholder="Nombre corto">
    </div>
  </div>
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
    <input type="hidden" name="CATEGORIA_ID" value="<?php echo $cat->ID_CATEGORIA; ?>">
      <button type="submit" class="btn btn-block btn-success">Actualizar Categoria</button>
                        ...
                        <!-- <a href="index.php?action=delcategory&CATEGORIA_ID=<?php echo $cat->ID_CATEGORIA; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>  -->
                        </td>
                        </tr>
<?php endforeach; ?>
 <?php endif; ?>
