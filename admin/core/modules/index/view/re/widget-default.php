...
$q= OperationData::getQYesF($product->ID_PRODUCTO);
	...
	<tr class="<?php if($q<=$product->inventary_min){ echo "danger"; }?>">
		...
		<input type="" class="form-control" required name="CANTIDAD" placeholder="Cantidad de producto ..."></td>
...
$product = ProductData::getById($p["PRODUCTO_ID"]);
?>
<tr >
	<td><?php echo $product->ID_PRODUCTO; ?></td>
	<td ><?php echo $p["CANTIDAD"]; ?></td>
	<td><?php echo $product->NOMBRE; ?></td>
	<td><b>$ <?php echo number_format($product->PRECIO); ?></b></td>
	<td><b>$ <?php  $pt = $product->PRECIO*$p["CANTIDAD"]; $total +=$pt; echo number_format($pt); ?></b></td>
	<td style="width:30px;"><a href="index.php?view=clearre&PRODUCTO_ID=<?php echo $product->ID_PRODUCTO; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a></td>
</tr>
