...
<br><table class="table table-bordered table-hover">
	...
	?>
	<tr class="<?php if($q<=$product->INVENTARIO_MIN/2){ echo "danger";}else if($q<=$product->INVENTARIO_MIN){ echo "warning";}?>">
...
<!--		<a href="index.php?view=input&product_id=<?php echo $product->ID_PRODUCTO; ?>" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-circle-arrow-up"></i> Alta</a>-->
		<a href="index.php?view=history&PRODUCTO_ID=<?php echo $product->ID_PRODUCTO; ?>" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-time"></i> Historial</a>
		</td>
	</tr>
	<?php endforeach;?>
</table>
