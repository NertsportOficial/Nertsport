...
<tr >
	...
	<td style="width:30px;"><a href="index.php?view=clearcart&PRODUCTO_ID=<?php echo $product->ID_PRODUCTO; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i> Cancelar</a></td>
</tr>
